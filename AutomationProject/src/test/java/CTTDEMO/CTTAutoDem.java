...
import org.openqa.selenium.WebDriver;
	...
	public class CTTAutoDem {
		...
		@Test(priority = 3)
		public void Login_Person_Name() throws InterruptedException {
		...
		@Test(priority = 5)
		public void User_Modified() throws InterruptedException {
		...
		public void Create_Project() throws InterruptedException {
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//input[@id='Descriptioncreate-user']")).sendKeys("AAABC");// Disc
			Thread.sleep(1000);
			...
			driver.findElement(
					...
					.click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@name=\"ProjectGroup\"][1]")).sendKeys("AAABC");// Project Group
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@name=\"Domain\"][1]")).sendKeys("AAABC");// Project domain
			Thread.sleep(1000);
		...
		@Test(priority = 8)
		public void OpenCreatedProject_AddJSON_File() throws InterruptedException {
			Thread.sleep(8000);
			// Click on home page
				driver.findElement(By.xpath("//*[@id=\"root\"]/div[1]/div[1]/header/div/div[1]/div[3]/div[1]/p/button")).click();
				Thread.sleep(4000);
				// Open specific
				WebElement element1t = driver.findElement(By.xpath("//*[contains(text(), 'AAABC')]"));
				element1t.click();
				Thread.sleep(8000);
				...
				WebElement dataload = driver.findElement(By.xpath("//*[@id='project_version']"));
				// Get the text content of the element
				String actualT = dataload.getText();
				// Expected text
				String expectedTextr = "1.1";
				// Verify the text using assertions
				Assert.assertEquals(expectedTextr, actualT);
				Thread.sleep(10000);
				// Click on load jsON
		...
		public void OpenSameProject_ChecksHeaderTab() throws InterruptedException {
			Thread.sleep(8000);
			// Open specific
				WebElement xyz = driver.findElement(By.xpath("//*[contains(text(), 'AAABC')]"));
				xyz.click();
				Thread.sleep(8000);
				// Right-click on root node
		...
		@Test(priority = 11)
		public void AddNew_User_InProject() throws InterruptedException {
			// Click on Add user
				...
				WebElement project = parentDiv.findElement(By.xpath("//*[contains(text(), 'AAABC')]"));
				Thread.sleep(4000);
		...
		public void AddNew_User_To_Assigne_Node() throws InterruptedException {
			...
			WebElement element111 = driver.findElement(By.xpath("//*[contains(text(), 'AAABC')]"));
			element111.click();
			Thread.sleep(6000);
			...
			Thread.sleep(3000);
			//  Click on the  node 
			WebElement rootnode11 = driver.findElement(By.xpath("(//*[contains(text(),'Motors')])[1]"));
		...
		public void open_assigne_node() throws InterruptedException {
			...
			// Find the specific project name within the parent div class
			WebElement project11e = parentDiv11w11.findElement(By.xpath("//*[contains(text(), 'AAABC')]"));
			Thread.sleep(2000);
		...
		public void Add_Child_Node() throws InterruptedException {
			...
			Thread.sleep(2000);
			 // add child node name
			driver.findElement(By.xpath("//*[@id=\"CreateNodeName\"]")).sendKeys("CTTDemoTest");
			Thread.sleep(2000);
		...
		public void Verified_Node_As_Completed_Or_Not() throws InterruptedException {
			// Click on same project and check node as completed
				...
				Thread.sleep(3000);
				// Find the specific project name within the parent div class
				WebElement project1 = parentDiv1.findElement(By.xpath("//*[contains(text(), 'AAABC')]"));
				Thread.sleep(2000);
				//Click on the drop down
		...
		@Test(priority = 16)
		public void Reintegrated_The_NodeasCompleted() throws InterruptedException {
	// Open specific
				WebElement element11z = driver.findElement(By.xpath("//*[contains(text(), 'AAABC')]"));
				element11z.click();
				Thread.sleep(8000);
				// Right-click on root node
		...
		@Test(priority = 17)
		public void Verified_NodeAs_ReintegratedorNot() throws InterruptedException {
			// Click on the same project dropdown and check node is reintegrtaed or not
				...
				Thread.sleep(4000);
				// Find the specific project name within the parent div class
				WebElement project11 = parentDiv11.findElement(By.xpath("//*[contains(text(), 'AAABC')]"));
				Thread.sleep(4000);
				 // Click on the drop down
		...
		public void Reintegrted_Node_Reassigned_To_The_Analyst() throws InterruptedException {
			// Open specific
				WebElement element11z1 = driver.findElement(By.xpath("//*[contains(text(), 'AAABC')]"));
				element11z1.click();
				Thread.sleep(8000);
				// Right-click on root node
				// Locate the iframe using CSS selector
		...
		public void Verified_Reintegrted_Status_ChangedTo_Assign() throws InterruptedException {
				...
				Thread.sleep(2000);
				// Find the specific project name within the parent div class
				WebElement project11t = parentDiv11t.findElement(By.xpath("//*[contains(text(), 'AAABC')]"));
				Thread.sleep(2000);
				 // Click on the drop down
		...
		public void Verifyed_AGGrid_and_Search_Taxonomy() throws InterruptedException {
			// Open specific
				WebElement element11 = driver.findElement(By.xpath("//*[contains(text(), 'AAABC')]"));
				element11.click();
				Thread.sleep(8000);
				// Right-click on root node
				WebElement iframe1 = driver.findElement(By.xpath("(//iframe[@id='iframeD3'])[1]"));
