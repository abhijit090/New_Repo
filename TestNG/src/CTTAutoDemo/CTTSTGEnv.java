package CTTAutoDemo;
	...
	public class CTTSTGEnv {
		...
		public void Create_New_Project() throws InterruptedException {
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//input[@id='Descriptioncreate-user']")).sendKeys("AaaaA0901");// Disc
			Thread.sleep(1000);
			...
			driver.findElement(
					...
					.click();
			Thread.sleep(1000);
//			driver.findElement(By.xpath("//*[@name=\"ProjectGroup\"][1]")).sendKeys("AaaaAB");// Project Group
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@name='Domain'][1]")).sendKeys("AaaaA0901");// Project domain
			Thread.sleep(1000);
		...
		public void Open_Created_Project_and_Add_JSON_File() throws InterruptedException {
			// Click on home page
				...
				Thread.sleep(3000);
				// Open specific
				WebElement element1t = driver.findElement(By.xpath("(//*[contains(text(), 'AaaaA0901')])[2]"));
				element1t.click();
				Thread.sleep(8000);
		...
		public void Open_Same_Project_Check_Header_Tab() throws InterruptedException {
			// Open specific
				WebElement element11 = driver.findElement(By.xpath("(//*[contains(text(), 'AaaaA0901')])[2]"));
				element11.click();
				Thread.sleep(10000);
				// Right-click on root node
		...
		public void AddNew_User_to_The_Project() throws InterruptedException {
			// Click on Add user
				...
				WebElement project = parentDiv.findElement(By.xpath("(//*[contains(text(), 'AaaaA0901')])[2]"));
				Thread.sleep(2500);
		...
		public void AddNew_User_To_Assigne_Node() throws InterruptedException {
			...
			WebElement element111 = driver.findElement(By.xpath("(//*[contains(text(), 'AaaaA0901')])[2]"));
			element111.click();
			Thread.sleep(8000);
...
//			}
			...
			Thread.sleep(3000);
			// Find the specific project name within the parent div class
			WebElement project11e = wait.until(ExpectedConditions.visibilityOf(parentDiv11w11.findElement(By.xpath("(//*[contains(text(), 'AaaaA0901')])[2]"))));
			Thread.sleep(3000);
			// Click on the drop down
		...
		public void Verified_Node_As_Completed_Or_Not() throws InterruptedException {
			// Click on same project and check node as completed
				...
				Thread.sleep(4000);
				// Find the specific project name within the parent div class
				WebElement project1 = parentDiv1.findElement(By.xpath("(//*[contains(text(), 'AaaaA0901')])[2]"));
				Thread.sleep(4000);
				//Click on the drop down
		...
		public void Reintegrated_The_Node_as_Completed() throws InterruptedException {
			// Open specific
				WebElement element11z = driver.findElement(By.xpath("(//*[contains(text(), 'AaaaA0901')])[2]"));
				element11z.click();
				Thread.sleep(15000);
				// Right-click on root node
		...
		public void Verified_Node_Status_As_Reintegrated_or_Not() throws InterruptedException {
			// Click on the same project dropdown and check node is reintegrtaed or not
				...
				Thread.sleep(4000);
				// Find the specific project name within the parent div class
				WebElement project11 = parentDiv11.findElement(By.xpath("(//*[contains(text(), 'AaaaA0901')])[2]"));
				Thread.sleep(4000);
				 // Click on the drop down
		...
		public void Reintegrted_Node_Reassigned_To_The_Analyst() throws InterruptedException {
			// Open specific
				WebElement element11z1 = driver.findElement(By.xpath("(//*[contains(text(), 'AaaaA0901')])[2]"));
				element11z1.click();
				Thread.sleep(8000);
				// Right-click on root node
				// Locate the iframe using CSS selector
		...
		public void Verified_Reintegrted_Status_ChangedTo_Assign() throws InterruptedException {
				...
				Thread.sleep(3000);
				// Find the specific project name within the parent div class
				WebElement project11t = parentDiv11t.findElement(By.xpath("(//*[contains(text(), 'AaaaA0901')])[2]"));
				Thread.sleep(5000);
				 // Click on the drop down
