...
import org.openqa.selenium.interactions.Actions;
	...
	public class CTTAutoDem {
		...
		public void Create_New_Project() throws InterruptedException {
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//input[@id='Descriptioncreate-user']")).sendKeys("AaaDemo");// Disc
			Thread.sleep(1000);
...
//			driver.findElement(By.xpath("//*[@name=\"ProjectGroup\"][1]")).sendKeys("AaaaAB");// Project Group
			Thread.sleep(1000);
			driver.findElement(By.xpath("//*[@name='Domain'][1]")).sendKeys("AaaDemo");// Project domain
			Thread.sleep(1000);
		...
		public void Open_Created_Project_and_Add_JSON_File() throws InterruptedException {
			// Click on home page
				...
				Thread.sleep(4000);
				// Open specific
				WebElement element1t = driver.findElement(By.xpath("//*[contains(text(), 'AaaDemo')]"));
				element1t.click();
				Thread.sleep(15000);
		...
		public void AddNew_User_to_The_Project() throws InterruptedException {
			// Click on Add user
				...
				WebElement project = parentDiv.findElement(By.xpath("//*[contains(text(), 'AaaDemo')]"));
				Thread.sleep(3000);
		...
		public void open_Assigne_node() throws InterruptedException {
			...
			// Find the specific project name within the parent div class
			WebElement project11e = parentDiv11w11.findElement(By.xpath("//*[contains(text(), 'AaaDemo')]"));
			Thread.sleep(3000);
		...
		public void Verified_Node_As_Completed_Or_Not() throws InterruptedException {
			// Click on same project and check node as completed
				...
				Thread.sleep(4000);
				// Find the specific project name within the parent div class
				WebElement project1 = parentDiv1.findElement(By.xpath("//*[contains(text(), 'AaaDemo')]"));
				Thread.sleep(4000);
				//Click on the drop down
		...
		public void Verified_Node_Status_As_Reintegrated_or_Not() throws InterruptedException {
			// Click on the same project dropdown and check node is reintegrtaed or not
				...
				Thread.sleep(4000);
				// Find the specific project name within the parent div class
				WebElement project11 = parentDiv11.findElement(By.xpath("//*[contains(text(), 'AaaDemo')]"));
				Thread.sleep(4000);
				 // Click on the drop down
		...
		public void Verified_Reintegrted_Status_ChangedTo_Assign() throws InterruptedException {
				...
				Thread.sleep(3000);
				// Find the specific project name within the parent div class
				WebElement project11t = parentDiv11t.findElement(By.xpath("//*[contains(text(), 'AaaDemo')]"));
				Thread.sleep(5000);
				 // Click on the drop down
